...
export interface QuestionLevelRecord {
  questionId: string;
...
const allQuestions: QuestionLevelRecord[] = [];
...
for (const tEntry of manifest.topics) {
  ...
  for (const f of files) {
    ...
    for (const q of qs) {
      const qId = `Q-${String(questionCounter).padStart(5, "0")}`;
      ...
      // ─────────────────────────────────────────────────────────────
      const isPureFederalPolity =
        !/राजस्थान|राज्यपाल|उच्च न्यायालय|राष्ट्रपति शासन|एनजीटी|74 वें|स्थानीय स्वशासन/i.test(qText) &&
        (/भारत का राष्ट्रपति|भारत के राष्ट्रपति|राष्ट्रपति के निर्वाचन|राष्ट्रपति अपना त्याग-पत्र|राष्ट्रपति अपना त्यागपत्र|राष्ट्रपति पर महाभियोग|राष्ट्रपति के महाभियोग|उप-राष्ट्रपति|प्रधानमंत्री का चयन|अनुच्छेद 123 में राष्ट्रपति|अनुच्छेद 87 के अन्तर्गत भारत का राष्ट्रपति|अनुच्छेद 103 के तहत, राष्ट्रपति|अनुच्छेद 56|अनुच्छेद 61|कार्यवाहक राष्ट्रपति|निर्विरोध उपराष्ट्रपति|संसद के विश्रांतिकाल में अध्यादेश/i.test(
          qText
        ) ||
      ...
      const isBudget2025 = /बजट 2025-26|बजट 2026-27/i.test(qText);

      if (isPureFederalPolity) {
        status = "NEEDS_REVIEW";
        targetMasterId = 58;
        reason =
      ...
      // B. Rajasthan Governor (Topic 59)
        ...
        !/एकीकरण|1857|राष्ट्रपति शासन लागू/i.test(qText) &&
      ...
      // I. Dynasties: Guhil (41), Kachwaha (42), Chauhan (43), Gurjar-Pratihar (44), Rathore (45), Other (46)
        ...
        status = "CONFIDENT";
        reason = "Content verified: Core examinable fact tests Amer/Jaipur Kachwaha dynasty rulers and achievements.";
      } else if (
...
console.log(`Saved JSON: ${jsonPath} (${allQuestions.length} entries)`);
...
console.log(`Saved CSV: ${csvPath} (${allQuestions.length} rows)`);
